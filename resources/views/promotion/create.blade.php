  ...
  <h4>Promotion Start Date:</h4>
        <div class="date">
                                                <div class="input-group date" id="datetimepicker1">
                                                    <input type="text" class="example1 form-control" id="add_reservation_date" name="startDate" placeholder="Start Date" required="">
       ...
       <div class=" col-xs-12 col-md-6 col-lg-7 form-group">
        ...
        <div class="date">
                                                <div class="input-group date" id="datetimepicker1">
                                                    <input type="text" class="example1 form-control" id="add_reservation_date" name="endDate" placeholder="End Date" required="">
                                                    <span class="input-group-addon"><span class=""><i class="fa fa-calendar" aria-hidden="true"></i></span>
                                                    </span>
                                                </div>
                                            </div>
