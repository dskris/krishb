...
<head>
    ...
    <meta property="og:title" content="Services | The Dugout Oasis" />
    ...
    <title>Services | The Dugout Oasis</title>
...
<body>
    ...
    <div class="wrapper">
       ...
       <!--header start-->
        ...
        <!--page title start-->
        <section class="page-title background-title-services dark">
            <div class="container">
                <div class="row">
        ...
        <div class="row">
            <div class="m-bot-10 inline-block">
                <div class="heading-title-alt border-short-bottom text-center">
                    <h1 class="text-uppercase">SERVICES</h1>
                    <div class="half-txt">At the Dugout we are more than just a place that pours you a drink 
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row m-bot-30">
             ...
             <img class="img-100" src="{{url('web/img/event-1.jpg')}}">    
             </div>
            ...
            <hr>
            <p>Celebrate your birthday with us and let us pamper you and your friends. From a complimentary cocktail of choice and a round of shooters for your friends.  </p>
             </div>
             </div>
             </div>
            ...
            <img class="img-100" src="{{url('web/img/mobile-bar-large.jpg')}}">    
            </div>  
            ...
            <hr>
            <p>We want to power your events and parties. Let our bartenders tend to your liquid needs while u party away. Find out more on how we can bring the Dugout experience right to your doorstep. Be the talk of the town.</p>
             </div>
             </div>
            ...
            <!--item ends-->
             ...
             <div class="row m-bot-30">
             <div class="col-md-6 col-sm-12">
             <img class="img-100" src="{{url('web/img/dugout-pundit-large.jpg')}}">    
             </div>
             
             <div class="col-md-6 col-sm-12">
             <div class="services">
            <h2>The Dugout Pundit</h2>

            <hr>
            <p>Nothing like watching a game with a little wager on it. Predict the scores for the games we screen and win free drinks and food </p>
             </div>
             </div>
             </div>
