...
<head>
    ...
    <title>Home & Away Oasis | Events</title>
                    ...
                    <div class="row">
                        <div class="concept">
                            <div class="col-md-5 col-sm-12">
                                <img class="img-100" src="{{url('/assets/img/gallery').'/'.$events->photo_path}}">
                            </div>

                            <div class="col-md-7 col-sm-12">
                                <h3>{{$events->event_name}}</h3>
                                <ul>
                                    <li><img src="{{url('web/img/time-01.svg')}}">{{date('d F Y, h:i A', strtotime($events->event_date))}}</li>
                                    <li><img src="{{url('web/img/venue-01.svg')}}">{{$events->event_location}}</li>
                                </ul>
                    ...
                    <!--<div class="text-center col-md-12">
                       ...
                       @if(count($event) > 0)
                                                         <div class="text-center col-md-12">
                                                                    ...
                                                                    ?>
                                                                    <ul class="pagination custom-pagination">{{$paginationLink}}</div>
                                                                </div>
