...
<head>
    ...
    <title>Home & Away Oasis | Authenticity Guarantee</title>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h1 class="text-uppercase">100% AUTHENTICITY GUARANTEE</h1>
            ...
            <p>Here at Home and Away we 100% guarantee that all alcohol sold on our outlets are
            the following:</p>
            <ul>
            ...
            <p>All of our alcohol and food products are purchased from licensed distributors or directly from the importer. Every item is inspected thoroughly and confirmed to be genuine before delivering to you.</p>
             ...
             <div class="col-md-6 col-sm-12 no-padding-desktop">
            <img class="img-100" src="{{url('web/img/authenticity.jpg')}}">    
            </div>
