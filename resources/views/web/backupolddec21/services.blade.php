...
<head>
    ...
    <title>Home & Away Oasis | Services</title>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h1 class="text-uppercase">HOME AND AWAY SERVICE</h1>
        <div class="half-txt">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo.
            ...
            <div class="row m-bot-30">
             ...
             <img class="img-100" src="{{url('web/img/birthday-events.jpg')}}">    
             </div>
            ...
            <img class="img-100" src="{{url('web/img/mobile-bar.jpg')}}">    
            </div>  
            ...
            <!--item ends-->
             ...
             <div class="row m-bot-30">
             <div class="col-md-6 col-sm-12">
             <img class="img-100" src="{{url('web/img/home-pundit.jpg')}}">    
             </div>
             
            <div class="col-md-6 col-sm-12">
            <div class="services">
            <h2>Home and Away Pundit</h2>          
            <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.</p>
             </div>
             </div>
             </div>
