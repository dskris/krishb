...
<head>
    ...
    <meta property="og:title" content="Authenticity Guarantee | The Dugout Oasis" />
    ...
    <title>Authenticity Guarantee | The Dugout Oasis</title>
...
<body> 
    ...
    <div class="wrapper">
       ...
       <!--header start-->
        ...
        <!--header end-->
        <!--page title start-->
        <section class="page-title background-title-authenticity dark">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                    <h1 class="text-uppercase">AUTHENTHIC ALCHOHOL GUARANTEE</h1>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="body-content">
            <div class="page-content">
                <div class="container">
                    ...
                    <h1 class="text-uppercase">100% AUTHENTICITY GUARANTEE</h1>
                    </div>
                    </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-ms-12 ">
                            <div class="col-md-6 col-sm-12 p-xs-lr-0">
                                <div class="authenticity">
                                    <h2>Our Promise to You</h2>
                                    <p>Here at The Dugout we 100% guarantee that all alcohol sold on our outlets are
                                    the following:</p>
                                    <ul>
                                        <li>100% Genuine Brand Goods</li>
                                        <li>Official Product from a Reputable or Direct Source</li>
                                        <li>Not Replica or Counterfeit Product/Items</li>
                                        <li>Safe to drink and meet all Malaysia Laws</li>
                                        <li>Brand New &amp; Unopened Products</li>
                                    </ul>

                                    <p>All of our alcohol and food products are purchased from licensed distributors or directly from the importer. Every item is inspected thoroughly and confirmed to be genuine before delivering to you.</p>
                                </div>
                            </div>

                            <div class="col-md-6 col-sm-12 p-xs-lr-0">
                                <img class="img-100" src="{{url('web/img/2211.jpg')}}">    
                            </div>
                        </div>
                    </div>
                </div> 
                        ...
                        <div class="concept-modal">
                            ...
                            <div class="col-md-6 col-sm-12 mobile-textcenter">
                                ...
                                <ul>
                                    ...
                                    <li><img src="{{url('web/img/pin.svg')}}">The Dugout Oasis, Ara Damansara</li>
                                </ul>
