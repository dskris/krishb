...
<head>
    ...
    <meta property="og:title" content="Events | The Dugout Oasis" />
    ...
    <title>Events | The Dugout Oasis</title>
...
<body>
    ...
    <div class="wrapper">
       ...
       <!--header start-->
        ...
        <!--page title start-->
        <section class="page-title background-title-events dark">
            <div class="container">
                <div class="row">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="m-bot-10 inline-block">
                            <div class="heading-title-alt border-short-bottom text-center">
                                ...
                                <div class="half-txt">There is always something happening at The Dugout. Watch this space for upcoming events
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="concept">
                            <div class="col-md-5 col-sm-12">
                                <img class="img-100" style="height:295px;" src="{{url('/assets/img/gallery').'/'.$events->photo_path}}">
                            </div>

                            <div class="col-md-7 col-sm-12 mobile-textcenter">
                                <h3>{{$events->event_name}}</h3>
                                <ul>
                                    <li><img src="{{url('web/img/time.svg')}}">{{date('d F Y, h:i A', strtotime($events->event_date))}}</li>
                                    <li><img src="{{url('web/img/pin.svg')}}">{{$events->event_location}}</li>
                                </ul>
                    ...
                    <!--<div class="text-center col-md-12">
                       ...
                       @if(count($event) > 0)
                                                         <div class="text-center col-md-12">
                                                                    <?php
                                                                    $paginationLink = $event->links('vendor.pagination.custom');

                                                                        if(request()->has('search'))
                                                                            $paginationLink = $event->appends(['search' => request()->input('search')])->links('vendor.pagination.custom');
                                                                    ?>
                                                                    {{$paginationLink}}</div>
                                                                        <!--<div class="text-center col-md-12">
                                                <ul class="pagination custom-pagination">
