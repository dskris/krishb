...
<head>
    ...
    <meta property="og:title" content="Gallery | The Dugout Oasis" />
    ...
    <title>Gallery | The Dugout Oasis</title>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="round-tabs text-center">
                                <ul class="nav nav-pills events mobile-pills-padding">
                                ...
                                <div class="panel-body">
                                    ...
                                    @foreach($food as $foods)
                                                <div class="col-lg-3 col-sm-6 col-xs-12"><a title="Image 1" href="#gallery-modal"><img class="thumbnail img-100" src="{{url('/assets/img/gallery').'/'.$foods->new_photo_path}}"></a></div>
                                                  @endforeach
                                                    @else
                                    ...
                                    @foreach($drink as $drinks)
                                                ...
                                                <div class="col-lg-3 col-sm-6 col-xs-12"><a title="Image 1" href="#gallery-modal"><img class="thumbnail img-100" src="{{url('/assets/img/gallery').'/'.$drinks->new_photo_path}}"></a></div>
                                    ...
                                    @foreach($event as $events) 
                                                <div class="col-lg-3 col-sm-6 col-xs-12"><a title="Image 1" href="#gallery-modal"><img class="thumbnail img-100" src="{{url('/assets/img/gallery').'/'.$events->new_photo_path}}"></a></div>
